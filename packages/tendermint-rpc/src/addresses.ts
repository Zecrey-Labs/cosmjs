...
export function rawEdbLS12377PubkeyToRawAddress(pubkeyData: Uint8Array): Uint8Array {
  if (pubkeyData.length !== 32) {
    throw new Error(`Invalid edbls12377 pubkey length: ${pubkeyData.length}`);
  }
  return sha256(pubkeyData).slice(0, 20);
}
...
export function pubkeyToRawAddress(
  type: "ed25519" | "secp256k1" | "edbls12377",
  data: Uint8Array,
): Uint8Array {
  switch (type) {
    case "ed25519":
    ...
    case "edbls12377":
      return rawEdbLS12377PubkeyToRawAddress(data);
    default:
 ...
 * For secp256k1 this assumes we already have a compressed pubkey, which is the default in Cosmos.
 */
export function pubkeyToAddress(type: "ed25519" | "secp256k1" | "edbls12377", data: Uint8Array): string {
