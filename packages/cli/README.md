...
[![npm version](https://img.shields.io/npm/v/@zkkontos/cli.svg)](https://www.npmjs.com/package/@zkkontos/cli)
...
```
$ npm install @zkkontos/cli --save-dev
$ ./node_modules/.bin/cosmjs-cli
```
...
```
$ npm install -g @zkkontos/cli
$ cosmjs-cli
```

## Getting started

1. Install `@zkkontos/cli` and run `cosmjs-cli` as shown above
