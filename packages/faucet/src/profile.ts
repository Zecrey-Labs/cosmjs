import { pathToString } from "@zkkontos/crypto";
import { DirectSecp256k1HdWallet, OfflineSigner } from "@zkkontos/proto-signing";
import { SigningStargateClient } from "@zkkontos/stargate";
