import { StdFee } from "@zkkontos/amino";
import { Decimal, Uint53 } from "@zkkontos/math";
import { coins } from "@zkkontos/proto-signing";
...
export class GasPrice {
   ...
   * See `GasPrice` in @zkkontos/stargate for a more generic matcher.
   *
