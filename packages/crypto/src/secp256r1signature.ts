...
export class Secp256r1Signature {
  /**
   ...
   */
  public static fromFixedLength(data: Uint8Array): Secp256r1Signature {
    if (data.length !== 64) {
  ...
  public static fromDer(data: Uint8Array): Secp256r1Signature {
    let pos = 0;
...
/**
 * A Secp256r1Signature plus the recovery parameter
 */
export class ExtendedSecp256r1Signature extends Secp256r1Signature {
  /**
   * Decode extended signature from the simple fixed length encoding
   * described in toFixedLength().
   */
  public static override fromFixedLength(data: Uint8Array): ExtendedSecp256r1Signature {
    if (data.length !== 65) {
