...
export const protobufPackage = "cosmos.crypto.edbls12377";
/**
 * PubKey is an bls12377 public key for handling Tendermint keys in SDK.
 * It's needed for Any serialization and SDK compatibility.
 */
export interface PubKey {
  key: Uint8Array;
}
/** PrivKey defines a bls12377 private key. */
