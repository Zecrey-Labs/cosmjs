...
import { fromAscii, fromHex, toAscii, toHex, toUtf8 } from "@zkkontos/encoding";
import { DirectSecp256k1HdWallet, OfflineDirectSigner, Registry } from "@zkkontos/proto-signing";
import {
